    ...
    <>
      ...
      <div className="mx-[20px] mb-[18px]" style={{ background: 'var(--bg-2)', border: '1px solid var(--border)', borderRadius: 16, padding: 16 }}>
        <div className="grid grid-cols-2 gap-[8px]">
          ...
          <a href="mailto:support@xautracker.com" className="flex items-center justify-center gap-[7px] py-[12px] text-[12px] font-semibold rounded-[8px] no-underline" style={{ background: 'transparent', color: 'var(--ink-2)', border: '1px solid var(--border)' }}>
